...
//  Project 8
//
//  Created by Tuğşad Şen on 18.03.2022.
//
...
class ViewController: UIViewController {
    ...
    @objc func submitTapped(_ sender: UIButton){
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            if wrongAnswer % 3 == 0 {
                score -= 1
                let ac = UIAlertController(title: "You entered \(wrongAnswer) wrong answer", message: "Your score has dropped by 1 point", preferredStyle: .alert)
